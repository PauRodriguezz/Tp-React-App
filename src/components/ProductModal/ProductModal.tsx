...
const ProductModal = ({show, onHide, title, modalType, prod, refreshData}:ProductModalProps) => {
        ...
        //CREATE - UPDATE - configuracion de hadleSaveUpdate
        ...
        const validationSchema = () => {
         ...
         //Formik, utiliza el esquema de validacion para crear un formulario dinamico y que lo bloquee en caso de errores
